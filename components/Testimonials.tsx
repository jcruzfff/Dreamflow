...
const Testimonials = () => {
  ...
  // Functions to navigate slides with fade-out effect
  const nextSlide = () => {
  ...
  useEffect(() => {
    ...
    if (contentRef.current) {
      ...
      if (quoteElement) {
        // Split the text into lines based on reasonable line breaks
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="max-w-4xl mx-auto relative">
          ...
          >
            ...
            <div 
              ref={imageRef}
              className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 rounded-full overflow-hidden mb-6 sm:mb-8 md:mb-10 lg:mb-12"
            >
              <Image 
            ...
            >
              <p className="testimonial-content text-[36px] text-white font-normal leading-[130%]">
            ...
            <div className="author-info flex flex-col items-center">
              <div className="text-sm sm:text-base md:text-lg lg:text-[22px] text-white font-medium mb-1">
                {testimonials[currentSlide].title}
              </div>
              <div className="text-sm sm:text-base md:text-lg lg:text-[22px] text-gray-400 font-medium mb-3">
        ...
        <div 
          ref={awardsRef}
          className="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-10 lg:gap-[68px] mt-10"
        >
          <Image 
            ...
            width={174}
            height={77}
            className="h-14 w-auto sm:h-16 md:h-20 lg:w-[174px] lg:h-[77px]" 
          />
          <Image 
